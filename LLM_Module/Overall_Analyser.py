...
class VideoResumeEvaluator:
    ...
    3. Did they use any gestures with their hands or body while speaking?, (Observe the speaker carefully. Mention whether you noticed meaningful gestures or body movements during their speech. Comment if the gestures enhanced the delivery or if there were minimal or distracting gestures. Give your answer in a short but clear sentence based on your observation, without guessing. In 2-3 lines)
    4. Did they have expressions on their face?, (Observe the speaker’s facial expressions carefully. Mention whether the speaker maintained expressive facial gestures or appeared neutral or stiff. Comment on how their expressions contributed to or affected the impact of the speech. Give your answer in a short but clear sentence based on your observation, without guessing. In 2-3 lines)
    5. Did the speech have a structure of Opening, Body and Conclusion? (Give 2-3 line descriptive Explanation, no straight answers or marks should be provided, i want descriptive answers, this is mandatory  but seperated by full stops. Avoid conjunctions and commas)
    6. Was the overall “Objective” of the speech delivered clearly? (Give 2-3 line descriptive Explanation, no straight answers or marks should be provided, i want descriptive answers, this is mandatory  but seperated by full stops. Avoid conjunctions and commas)
    7. Was the content of the presentation/speech to the point, or did it include unnecessary details that may have distracted or confused the audience? (Give 2-3 line Explanation, no straight answers or marks should be provided, i want descriptive answers, this is mandatory)
   
    8. Was the content of the presentation/speech relevant to the objective of the presentation?  (3-4 lines Descriptive Answer  but seperated by full stops. Avoid conjunctions and commas)
    9. Was the content of the presentation/speech clear and easy to understand?  (2-3 lines explanation about hwo good or bad it was)
    10. Did the speaker keep the presentation engaging by adding relevant examples, anecdotes and data to back their content? (2-3 lines descriptive answer)
    11. Did the speaker demonstrate credibility? Will you trust the speaker?   (2-3 lines descriptive answer but seperated by full stops. Avoid conjunctions and commas)
    12. Did the speaker explain how the speech or topic of the presentation would benefit the audience and what they could gain from it?(2-3 lines descriptive answer but seperate it with full stops)
    13. Did the speaker make an emotional connection with the audience ? (2-3 lines descriptive answer  but seperated by full stops. Avoid conjunctions and commas)
    14. Overall, were you convinced/ persuaded with the speaker’s view on the topic? (2-3 lines descriptive answer but sepearate it with full stops and not commas, and no straight answers or marks should be provided, i want descriptive answers, this is mandatory)
